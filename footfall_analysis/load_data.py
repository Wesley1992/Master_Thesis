...
for span in spans:
    for l2d in l2ds:
        for gamma in gammas:
            ...
            file_name='D:/Master_Thesis/footfall_analysis/data/data_mdl_funicular_0_4m/data_mdl_span'+str(span).replace('.','_')+'_l2d'+str(l2d).replace('.','_')+'_gamma'+str(gamma).replace('.','_')+'.pkl'
